...
## [Unreleased](https://github.com/chef/chef-dk/tree/HEAD)

[Full Changelog](https://github.com/chef/chef-dk/compare/0.7.0...HEAD)

**Closed issues:**

- Utilize system CA certificates, not standalone CA certificates [\#494](https://github.com/chef/chef-dk/issues/494)
- Add AlphaSSLCA-SHA256-G2 intermediate CA cert [\#493](https://github.com/chef/chef-dk/issues/493)
...
- Warning message when installing ChefDK 0.7 on Ubuntu 14.04 "The package is of bad quality" [\#481](https://github.com/chef/chef-dk/issues/481)
- chef-dk gem out of date [\#475](https://github.com/chef/chef-dk/issues/475)
- `chef verify` fails on Windows with ChefDK 0.7.0 [\#470](https://github.com/chef/chef-dk/issues/470)
- New install of ChefDK 0.6.2 gives buff-config error during chef verify [\#467](https://github.com/chef/chef-dk/issues/467)
- ChefDK 0.7.0 not available on https://downloads.chef.io/chef-dk/ [\#464](https://github.com/chef/chef-dk/issues/464)
- chefdk installation hangs on centos7 [\#462](https://github.com/chef/chef-dk/issues/462)
- Ubuntu 15.04 error message: The package is of bad quality [\#457](https://github.com/chef/chef-dk/issues/457)
- Kitchen create fails [\#454](https://github.com/chef/chef-dk/issues/454)
...
- Update changelog for policyfile delete commands and recent bugfixes [\#497](https://github.com/chef/chef-dk/pull/497) ([danielsdeleo](https://github.com/danielsdeleo))
...
- Add additional files to the chefignore file [\#478](https://github.com/chef/chef-dk/pull/478) ([tas50](https://github.com/tas50))
...
- `chef provision` is now documented on docs.chef.io [\#465](https://github.com/chef/chef-dk/pull/465) ([danielsdeleo](https://github.com/danielsdeleo))
...
- hef [\#453](https://github.com/chef/chef-dk/issues/453)
...
- ChefDK does not install successfully [\#418](https://github.com/chef/chef-dk/issues/418)
